...
<br>
    ...
    while ($row = mysqli_fetch_array($res)){
    ?>
    <form action="owner_detailedit_farmplan_insert_db.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="garden_id" style="display: none;" class="form-control" id="garden_id" value="<?php echo $row['garden_id'] ?>" name="garden_id" required> 
