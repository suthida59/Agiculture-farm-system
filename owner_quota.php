...
<div class="container-fluid">
  ...
  WHERE   quota_date = curdate() AND user.district_id = '".$_SESSION["district_id"]."' AND user_id = '".$_SESSION["user_id"]."'";  //user.district_id= 8 , user_id = 14 
  ...
  $res = mysqli_query($con,$query);
    ...
    ?>
        ...
        <td></td>
        <td><a href="./ownerquota_detail.php?quota_id=<?php echo $row["quota_id"]; ?>"><i class="btn btn-warning">ดูรายการ</a></td>
