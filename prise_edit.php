<!DOCTYPE html>
<html>
<title>แก้ไขข้อมูลสมาชิกเจ้าของฟาร์ม</title>
<?php
...
<div class="w3-row-padding">
  ...
  <div class="w3-container">
    <div class="w3-container w3-card w3-white w3-margin-bottom ">
      ...
      <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-camera-retro fa-5x fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>แก้ไขข้อมูลสมาชิกเจ้าของฟาร์ม</h2>
      <div class="w3-container">
    <?php 
    ...
    ?>
    <form action="./prise_update.php" method="get"class="needs-validation" novalidate>
        ...
        <div class="row">
         ...
         <div class="w3-row-padding">
             ...
             <div class="w3-half">
            <label for="lname">ชื่อ-สกุล</label>
            ...
            <div class="invalid-feedback">
             ...
             <div class="w3-half">
            <label for="lname">ชื่อผู้ใช้</label>
            ...
            <div class="invalid-feedback">
             ...
             <div class="w3-half">
            <label for="lname">ชื่อฟาร์ม</label><br>
            <input type="text" name="user_farm" class="form-control" value="<?php echo $row["user_farm"]?>" size="25" placeholder="ชื่อฟาร์ม"onkeypress="not_number(event)" required>
            <div class="invalid-feedback">
            ชื่อฟาร์ม
                   </div>
             </div>
        ...
        <div class="form-row">
                  <div class="form-group col-md">
                    <label for="TeBranch">ตำแหน่ง</label>
                    <select id="user_lavel" class="form-control selectpicker" data-live-search="true" name="user_lavel" required>
                      <option <?php if ($row['user_lavel'] == 'Admin วิสาหกิจชุมชน') echo 'selected="selected"'; ?> >เจ้าของฟาร์ม</option>
                    </select>
                    <div class="invalid-feedback">
                      กรุณาระบุตำแหน่ง!
                    </div>
