<!DOCTYPE html>
<html>
<title>ข้อมูลโควตาผักวันนี้</title>
<?php
...
<div class="container-fluid">
      ...
      <div class="shadow-lg p-3 mb-5 bg-white rounded" id="admin">
        ...
        <h2 style="text-align: center;">โควตาวันนี้</h2>
        <hr class="my-2">
        <nav class="navbar navbar-light" style="">
        <a href="quota_insertprise.php" class="badge badge-success"><h5>เพิ่มโควต้า</h5></a></p>
          <form class="form-inline">
          <a href="admin_prise.php" class="btn btn-danger my-2 my-sm-0" >ย้อนกลับ</a>&nbsp;
            <div class="form-group">
          <input class="form-control mr-sm-2" type="text" placeholder="ค้นหาข้อมูล" aria-label="Search" name="search" size="40" id="prise_search" />
            </div>
 ...
 $query ="SELECT * FROM quota WHERE  quota_date = curdate() AND quota_memberid ='".$_SESSION['user_id']."'";
  $res = mysqli_query($con,$query);
    ...
    ?>
        ...
        <td></td>
        <td><a href="./quotadetail.php?quota_id=<?php echo $row["quota_id"]; ?>"><i class="btn btn-warning">ดูรายการ</a></td>
