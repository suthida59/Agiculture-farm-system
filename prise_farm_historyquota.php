...
error_reporting(~E_NOTICE);//กันxampp แจ้ง
?>
<head>
    <meta charset="utf-8">
...
<div class="container-fluid">
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h2 class="card-title">เลือกผักที่รับโควตา <a href="prise_farm_historyquota.php?&&user_id=<?php echo $user_id;?>" class="btn btn-primary">แสดงรายระเอียดทั้งหมด</a>&nbsp;<a href="prise_farm_detail.php?user_id=<?php echo $user_id;?>" class="btn btn-danger">ย้อนกลับ</a></h2>
        <p class="card-text"></p>
        <table class="table">
          <thead>
          <tr>
        ...
        <?php
        $user_id = $_GET["user_id"];
        $q2 = "SELECT * FROM user as u 
        INNER JOIN farm  as f ON u.user_id=f.farmuser_id
        WHERE f.farmuser_id ='$user_id'"; //farmuser_id = 14
        ...
        <tr>
          ...
          <td><a href="prise_farm_historyquota.php?seed=<?php echo $row["quotadetail_nameseed"];?>&&user_id=<?php echo $user_id;?>" class="btn btn-warning">แสดงรายระเอียด</a><br></td>
        </tr>
         <?php
         } ?>
         </tbody>
